...
function Landing({ onEnter, user, profile, onShowAuth, onSignOut, onUpgrade, onProfileRefresh, toast, onAdmin, navigate, onDashboard }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      ...
      {/* HERO */}
      <section className="hero-section section-pad" style={{ maxWidth:1060, margin:"0 auto", padding:"clamp(48px,9vw,100px) clamp(16px,5vw,52px) clamp(48px,7vw,88px)", display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:"clamp(28px,6vw,72px)", alignItems:"center", textAlign: isMobile ? "center" : "left" }}>
        <div>
