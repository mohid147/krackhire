...
function Landing({ onEnter, user, profile, onShowAuth, onSignOut, onUpgrade, onProfileRefresh, toast, onAdmin, navigate, onDashboard }) {
  ...
  // 🔴 NEW: FOOLPROOF MOBILE DETECTION IN REACT
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, overflowX: "hidden" }}>
      ...
      <div className="ann-bar" style={{ background: C.sage, color: "#fff", textAlign: "center", padding: "9px 16px", fontSize: 13.5, fontWeight: 500, lineHeight: 1.5, overflow: "hidden" }}>
        {user
      ...
      <nav style={{ 
        ...
        background: scrolled ? "rgba(249,248,246,.96)" : "transparent", 
      ...
      {menuOpen && isMobile && (
        <div style={{ position:"fixed", top:"calc(35px + 52px)", left:0, right:0, zIndex:199, background:C.surface, borderBottom:`1px solid ${C.border}`, padding:"10px 14px", display:"flex", flexDirection:"column", gap:2, animation:"slideUp .2s ease", boxShadow:"0 6px 20px rgba(0,0,0,.08)" }}>
          ...
          <div style={{ paddingTop:10, borderTop:`1px solid ${C.border}`, marginTop:6, display:"flex", flexDirection:"column", gap:8 }}>
            ...
            {user&&<OutBtn onClick={()=>{setMenuOpen(false);onSignOut();}} style={{ justifyContent:"center", width:"100%", color: C.red, borderColor: C.red+"40" }}>Sign Out</OutBtn>}
          </div>
        </div>
      )}

      {/* HERO */}
      <section className="hero-section section-pad" style={{ maxWidth:1060, margin:"0 auto", padding:"clamp(48px,9vw,100px) clamp(16px,5vw,52px) clamp(48px,7vw,88px)", display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:"clamp(28px,6vw,72px)", alignItems:"center", textAlign: isMobile ? "center" : "left", overflow: "hidden" }}>
        <div>
          <Tag color={C.sage} bg={C.sageBg} style={{ marginBottom:16, display:"inline-flex" }}>Early beta — free to use</Tag>
          <h1 className="hero-title" style={{ fontFamily:"'Lora',Georgia,serif", fontSize:"clamp(28px,4vw,50px)", lineHeight:1.12, letterSpacing:"-.3px", color:C.ink, marginBottom:18, marginTop:12, background: isMobile ? "linear-gradient(135deg, #1C1917 0%, #44403C 100%)" : "none", WebkitBackgroundClip: isMobile ? "text" : "none", WebkitTextFillColor: isMobile ? "transparent" : "initial" }}>
            Understand why your resume gets rejected —<br/>
            <em style={{ fontStyle:"italic", color:C.sage, WebkitTextFillColor: C.sage }}>before you apply.</em>
          </h1>
          <p className="hero-sub" style={{ fontSize:"clamp(15px,1.7vw,17px)", color:C.ink2, lineHeight:1.85, marginBottom:28, maxWidth:500, margin: isMobile ? "0 auto 28px auto" : "0 0 28px 0" }}>
          ...
          <div className="hero-btns" style={{ display:"flex", gap:12, flexWrap:"wrap", marginBottom:24, flexDirection: isMobile ? "column" : "row", justifyContent: isMobile ? "center" : "flex-start" }}>
            <Btn onClick={onEnter} size="lg" bg={C.sage} style={{ width: isMobile ? "100%" : "auto" }}>Open the tool — it's free</Btn>
            {!user&&<OutBtn onClick={onShowAuth} size="lg" style={{ width: isMobile ? "100%" : "auto" }}>Sign in to save</OutBtn>}
          </div>
          <div className="hero-trust" style={{ display:"flex", flexWrap:"wrap", gap:16, justifyContent: isMobile ? "center" : "flex-start" }}>
          ...
          <Card flat style={{ overflow:"hidden", border:`1px solid ${C.border}` }}>
            ...
            <div style={{ padding:"18px 18px 14px" }}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
                <div className="score-card-inner" style={{ display:"flex", gap:16, flexWrap: "wrap", justifyContent: isMobile ? "center" : "flex-start", width: "100%" }}>
              ...
              {[{t:"red",i:"✗",title:"Missing: SQL basics",sub:"Found in 4/5 similar JDs."},{t:"amber",i:"△",title:"Weak: Project impact",sub:"Add numbers to your achievements."},{t:"green",i:"✓",title:"Strong: Ops experience",sub:"Relevant. Lead with this."}].map((g,i)=>{
                ...
                return <div key={i} style={{ display:"flex", gap:9, padding:"8px 11px", background:bg, borderRadius:7, borderLeft:`3px solid ${clr}`, marginBottom:7 }}>
                  ...
                  <div style={{ textAlign: "left" }}><div style={{ fontSize:12, fontWeight:700, color:clr }}>{g.title}</div><div style={{ fontSize:11.5, color:C.ink2, marginTop:1 }}>{g.sub}</div></div>
                </div>;
              })}
            </div>
          </Card>
      ...
      <section id="how" className="section-pad" style={{ background:C.surface, borderTop:`1px solid ${C.border}`, borderBottom:`1px solid ${C.border}`, padding:"64px clamp(16px,5vw,52px)" }}>
        <div style={{ maxWidth:1060, margin:"0 auto" }}>
          <Reveal>
            ...
            <div className="how-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(4,1fr)", border:`1px solid ${C.border}`, borderRadius:12, overflow:"hidden" }}>
              {[{n:"01",title:"Paste your resume",desc:"Any format. Copy the full text."},{n:"02",title:"Paste the job description",desc:"From Naukri, LinkedIn, anywhere."},{n:"03",title:"Get your score and gaps",desc:"Clear results in about 20 seconds."},{n:"04",title:"Improve and apply",desc:"Use feedback to strengthen applications."}].map((s,i)=>(
                <div key={i} style={{ padding:"24px 18px", borderRight: (i<3 && !isMobile) ? `1px solid ${C.border}` : "none", borderBottom: (i<3 && isMobile) ? `1px solid ${C.border}` : "none", background:C.surface, transition:"background .18s" }}
      ...
      <section id="features" className="section-pad" style={{ padding:"64px clamp(16px,5vw,52px)" }}>
        <div style={{ maxWidth:1060, margin:"0 auto" }}>
          <Reveal>
            ...
            <div className="features-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit,minmax(240px,1fr))", gap:10 }}>
              {FEATURES.map((f,i)=>(
      ...
      <section id="pricing" className="section-pad" style={{ background:C.surface, borderTop:`1px solid ${C.border}`, borderBottom:`1px solid ${C.border}`, padding:"64px clamp(16px,5vw,52px)" }}>
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <Reveal>
            ...
            <div className="pricing-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap:14 }}>
              <Card flat className="pricing-card" style={{ padding: isMobile ? "32px 20px" : "24px 20px", border:`1px solid ${C.border}` }}>
              ...
              <div style={{ position:"relative" }}>
                <Card flat className="pricing-card" style={{ padding: isMobile ? "32px 20px" : "24px 20px", border:`2px solid ${C.sage}`, boxShadow:"0 4px 20px rgba(61,107,79,.12)" }}>
              ...
              <div style={{ position:"relative" }}>
                ...
                <Card flat className="pricing-card" style={{ padding: isMobile ? "32px 20px" : "24px 20px", border:`2px solid ${C.amber}30` }}>
      ...
      <section id="reviews" className="section-pad" style={{ padding:"64px clamp(16px,5vw,52px)" }}>
        <div style={{ maxWidth:1060, margin:"0 auto" }}>
          <Reveal>
            ...
            {!reviewsDone?<div className="reviews-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap:10 }}>{[1,2,3].map(i=><div key={i}><Skel h={130}/></div>)}</div>
              :reviews.length===0?
              ...
              :<>
                <div className="reviews-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap:10, marginBottom:20 }}>
                  {visible.map((r,i)=>(
      ...
      <section id="faq" className="section-pad" style={{ background:C.surface, borderTop:`1px solid ${C.border}`, padding:"64px clamp(16px,5vw,52px)" }}>
        <div style={{ maxWidth:1060, margin:"0 auto" }}>
          <Reveal>
            <div className="faq-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1.8fr", gap:"clamp(24px,6vw,64px)" }}>
              <div>
                <Tag>FAQ</Tag>
      ...
      <section className="section-pad" style={{ background:C.sageBg, borderTop:`1px solid ${C.sage}25`, padding:"72px clamp(16px,5vw,52px)", textAlign:"center" }}>
        <Reveal>
          ...
          <Btn onClick={onEnter} size="lg" bg={C.sage} style={{ width: isMobile ? "100%" : "auto" }}>Open KrackHire — free</Btn>
      ...
      <footer style={{ background:"#1C1917", color:"#fff", padding:"44px clamp(16px,5vw,52px) 28px" }}>
        <div style={{ maxWidth:1060, margin:"0 auto" }}>
          <div className="footer-grid" style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr", gap:"clamp(24px,4vw,48px)", paddingBottom:32, borderBottom:"1px solid #292524" }}>
            ...
            <div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                {[["#features","Features"],["#how","How it works"],["#pricing","Pricing"],["#faq","FAQ"]].map(([href,label])=>(
                  <a key={label} href={href} style={{ fontSize:13.5, color:"#78716C", lineHeight:1, display:"flex", alignItems:"center", minHeight:"unset", transition:"color .15s", textDecoration: "none" }}
